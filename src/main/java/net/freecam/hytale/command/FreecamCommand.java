...
/**
 * Main command to toggle freecam mode on/off.
 * Usage: /freecam
 * 
...
public class FreecamCommand extends CommandBase {
    ...
    public FreecamCommand() {
        super("freecam", "Toggle freecam mode - fly your camera freely through the world.");
    ...
    protected void executeSync(@Nonnull CommandContext ctx) {
        ...
        if (state.isFreecamEnabled(playerId)) {
            // Disable freecam - return camera to player
